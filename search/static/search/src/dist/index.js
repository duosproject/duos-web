...
},{"./cjs/react-dom.development.js":"node_modules/react-dom/cjs/react-dom.development.js"}],"components/SearchBar.js":[function(require,module,exports) {
"use strict";
...
function SearchResult(props) {
  return _react.default.createElement("div", {
    ...
    className: "is-size-6"
  }, props.data.articleName), "Authors:", _react.default.createElement("ul", null, props.data.authors.map(function (a) {
    return _react.default.createElement("li", {
      onClick: props.onClick
    }, a);
  })), "Datasets:", _react.default.createElement("ul", null, props.data.datasets.map(function (a) {
    return _react.default.createElement("li", {
      onClick: props.onClick
    }, a);
  ...
  _createClass(App, [{
    ...
    value: function handleSearch(e) {
      ...
      if (e.type === "click" || e.type === "keyup" && e.keyCode === 13) {
        fetch("".concat(window.location.href, "?q=").concat(this.state.searchQuery), {
          method: "GET",
          headers: {
            "Content-Type": "application/json; charset=utf-8"
          }
        }).then(function (res) {
          return res.ok ? res.json() : new Error("Error fetching search results :(");
        }).then(function (json) {
    ...
    value: function render() {
      ...
      }, "Browse the datasets and articles collected by the DUOS web crawler.", _react.default.createElement("span", {
        className: "has-text-weight-bold help"
      }, "Tip: you can use the * wildcard to search for partial terms.")), _react.default.createElement("div", {
...
_reactDom.default.render(_react.default.createElement(_App.default, null), window.root);
