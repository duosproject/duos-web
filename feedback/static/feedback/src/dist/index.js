...
},{"./cjs/react-dom.development.js":"node_modules/react-dom/cjs/react-dom.development.js"}],"components/ValidationField.js":[function(require,module,exports) {
"use strict";
...
/*#__PURE__*/
function (_Component) {
  _inherits(ValidationField, _Component);
  ...
  function ValidationField(props) {
    ...
    _this.USER_DONE_TYPING_TIMEOUT = 3500;
    _this.ANSWERS = [{
      display: "Yes",
      value: "yes"
    }, {
      ...
      display: "Let me clarify",
      value: "clarify"
    }, {
      display: "Unsure",
      value: "unsure"
    }];
    _this.handleUserIsTyping = _this.handleUserIsTyping.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
  ...
  _createClass(ValidationField, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      var _this$props$userRespo = this.props.userResponse,
          selection = _this$props$userRespo.selection,
          clarification = _this$props$userRespo.clarification;

      if ( // the user is pressing a different button than last press
      prevProps.userResponse.selection !== selection || // user's typed clarification has changed
    ...
    key: "handleUserIsTyping",
    value: function handleUserIsTyping(e, callback) {
      var _this2 = this;

      e.persist();
      setTimeout(function () {
        return callback(e, _this2.props.label);
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        className: "field columns is-multiline is-centered"
      }, _react.default.createElement("div", {
        className: "column"
      }, _react.default.createElement("label", {
        className: "label"
      }, this.props.label)), _react.default.createElement("div", {
        className: "column buttons has-addons control"
      }, this.ANSWERS.map(function (_ref) {
        var value = _ref.value,
            display = _ref.display;
        return _react.default.createElement("button", {
          onClick: function onClick(e) {
            return _this3.props.onChange(e);
          },
          className: "button ".concat(_this3.props.userResponse.selection == value ? "is-selected is-primary has-text-white-ter" : ""),
          value: value,
          name: value,
          key: _this3.props.datasetId + value
        }, display);
      })), this.props.userResponse.selection == "clarify" && _react.default.createElement("div", {
        className: "control column is-full"
      }, _react.default.createElement("textarea", {
        rows: 4,
        cols: 90,
        placeholder: "Briefly explain your use of ".concat(this.props.label, " here."),
        onChange: function onChange(e) {
          return _this3.handleUserIsTyping(e, _this3.props.onChange);
        },
        className: "textarea"
      })));
    }
...
},{"react":"node_modules/react/index.js"}],"components/ValidationForm.js":[function(require,module,exports) {
"use strict";
...
var _ValidationField = _interopRequireDefault(require("./ValidationField"));
...
function (_Component) {
  ...
  function ValidationForm(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ValidationForm).call(this, props)); // setting state from props
    // because question labels were born in the server

    _this.state = {
      userResponses: _this.props.datasets.map(function (_ref) {
        var name = _ref.name;
  ...
  _createClass(ValidationForm, [{
    key: "handleChange",
    value: function handleChange(e, formElement) {
      e.preventDefault();
      var value = e.target.value;
      var input = e.target.type === "textarea" ? {
        clarification: value
      } : {
        selection: value
      };
      this.setState(function (state) {
        return {
          userResponses: _objectSpread({}, state.userResponses, _defineProperty2({}, formElement, _objectSpread({}, state.userResponses[formElement], input))),
          progress: Object.keys(state.userResponses).filter(function (key) {
            return state.userResponses[key].selection != "" && key != formElement;
          }).length + 1
        };
      });
    }
    ...
    value: function render() {
      ...
      var _this$props$authorNam = this.props.authorName.split(" "),
          _this$props$authorNam2 = _slicedToArray(_this$props$authorNam, 1),
          firstName = _this$props$authorNam2[0];

      return _react.default.createElement("form", {
        className: "column box is-full has-background-clear"
      }, this.state.progress === Object.keys(this.state.userResponses).length ? _react.default.createElement("div", {
        className: "notification is-success"
      }, "Thank you for taking the time to complete this survey, ", firstName, ".", _react.default.createElement("br", null), "Your contribution will make a great impact in our research.") : _react.default.createElement("progress", {
        className: "progress is-primary",
        value: this.state.progress,
        max: Object.keys(this.state.userResponses).length
      }), this.props.datasets.map(function (_ref3) {
        var name = _ref3.name,
            id = _ref3.id;
        return _react.default.createElement(_ValidationField.default, _extends({
          label: name,
          key: id,
          datasetId: id,
          onChange: function onChange(e) {
          ...
          userResponse: _this2.state.userResponses[name]
        }, _this2.props));
      }));
    }
  }]);
...
},{"react":"node_modules/react/index.js","./ValidationField":"components/ValidationField.js"}],"components/App.js":[function(require,module,exports) {
"use strict";
...
function App(props) {
  ...
  }, _react.default.createElement("span", null, props.articleName), " ", _react.default.createElement("br", null), _react.default.createElement("span", {
    className: "is-size-5"
  }, "by ", props.authorName)), _react.default.createElement("article", {
    className: "column is-full"
  }, "Were the following datasets referenced in the paper mentioned above? Your answers are submitted automatically."), _react.default.createElement(_ValidationForm.default, props));
}
},{"react":"node_modules/react/index.js","./ValidationForm":"components/ValidationForm.js"}],"node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
_reactDom.default.render(_react.default.createElement(_App.default, window.props), window.root);
},{"react":"node_modules/react/index.js","react-dom":"node_modules/react-dom/index.js","./components/App":"components/App.js","./styles.scss":"styles.scss"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
